...
echo "Server.py will run with the following arguments Username: $CouchUser Pass: ##### IP: 127.0.0.1 Port: 5984 JWT SECRET KEY: $JWT"
python3 server.py $CouchUser $CouchPass 127.0.0.1 5984 $JWT
